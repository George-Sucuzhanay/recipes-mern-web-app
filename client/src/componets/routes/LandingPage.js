    ...
    return(
        ...
        <section className="mx-auto container py-20 ">
          <div className="flex justify-center items-center flex-col">
            <div className=" flex flex-wrap justify-center  lg:text-6xl md:text-5xl text-4xl font-black leading-10 text-center text-gray-800 dark:text-white pb-24">
            <img className='max-h-40' src='https://i.postimg.cc/XJQCw3Wn/logo.png' />
              <h1 className='flex items-center'>Tailor-made features</h1>
            </div>
